<?php /* Smarty version Smarty-3.0.6, created on 2017-05-20 01:05:02
         compiled from "tpl/index\list1.html" */ ?>
<?php /*%%SmartyHeaderCode:13624591ea51914bd40-62783683%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2289317f9a55abea5f3cbb6db78a767f49646fda' => 
    array (
      0 => 'tpl/index\\list1.html',
      1 => 1495180568,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13624591ea51914bd40-62783683',
  'function' => 
  array (
  ),
...
myimg/img_bg_3.jpg);background-position:center;background-attachment:fixed">
                        <div class="overlay-gradient"></div>
                        <div class="container-fluids">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3 slider-text slider-text-bg">
                                    <div class="slider-text-inner text-center">
                                        <h1><?php echo $_smarty_tpl->tpl_vars['v1']->value["title"];?>
</h1>
                                        <h2><?php echo $_smarty_tpl->tpl_vars['v1']->value["con"];?>
</h2>
                                    </div>
                                </div>
                            </div>
                ...
                <!--<div class="col-md-4">-->
                    <!--<div class="fh5co-blog animate-box">-->
                        ...
                        <!--<div class="blog-text">-->
                            ...
                            <!--<ul class="stuff">-->
                                <!--<li><a href="index.php?m=index&c=index&a=lists&cid=<?php echo $_smarty_tpl->tpl_vars['v1']->value['sid'];?>
">Read More<i class="icon-arrow-right22"></i></a></li>-->
    ...
    <div class="container-wrap">
        <footer id="fh5co-footer" role="contentinfo">
            <div class = "message" style = "width:100%;height:auto;"></div>
